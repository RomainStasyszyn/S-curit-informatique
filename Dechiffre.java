    ...
    public static void main(String[] args) {
        ...
        if (args.length == 3) {
            switch (args[0]) {
                case "c":
                    codage = "César";
                    System.out.println("Bonjour, vous avez choisi le décodage " + codage + " avec comme clé la valeur " + cle);
                    Cesar codeC = new Cesar();
                    codeC.dechiffrer(cle, args[2]);
                    break;
                case "p":
                    codage = "Permutation";
                    ...
                    codeP.dechiffrer(cle, args[2]);
                    break;
                case "v":
                    codage = "Vigenere";
                    System.out.println("Bonjour, vous avez choisi le décodage " + codage + " avec la clé " + cle);
                    Vigenere codeV = new Vigenere();
                    codeV.dechiffrer(cle, args[2]);
                    break;
                default:
